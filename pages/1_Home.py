...
with st.expander("Options Analytics Suite", expanded=True):
    ...
    <div class="card">
        ...
        <p><strong>Solution:</strong> A high-performance Streamlit application combining options Greeks (Delta, Gamma, Theta) with technical indicators (EMA, RSI, VWAP, Keltner Channels) to generate institutional-quality trading signals.</p>
        <ul>
    ...
    with col2:
        st.link_button("GitHub Repository", "https://github.com/wizard5919/options_analyzerPublic")
