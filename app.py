...
with st.expander("Options Analytics Suite"):
    ...
    <div class="card">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="/Options_Analyzer" target="_blank" style="flex: 1; background-color: #00C2FF; color: #0A1F44; border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">View Live Demo</a>
...
with st.expander("Market Sector Classifier"):
    ...
    <div class="card">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="/Sector_Classifier" target="_blank" style="flex: 1; background-color: #00C2FF; color: #0A1F44; border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">View Case Study</a>
...
with st.expander("Macroeconomic Dashboard"):
    ...
    <div class="card">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="/Macro_Dashboard" target="_blank" style="flex: 1; background-color: #00C2FF; color: #0A1F44; border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">Explore Dashboard</a>
