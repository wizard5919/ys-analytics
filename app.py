...
with st.expander("Options Analytics Suite", expanded=True):
    ...
    <div class="card">
        ...
        <div style="display: flex; gap: 10px;">
            <a href="https://optionsanalyzer-f8rf7r8kerrpjaaujxl937.streamlit.app/" target="_blank" style="flex: 1; background-color: #00C2FF; color: #0A1F44; border-radius: 8px; padding: 0.5rem 1.5rem; font-weight: 600; text-decoration: none;">View Live Demo</a>
